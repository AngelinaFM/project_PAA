#Nama : Angelina Febriani Madesen
#NIM  : F55123084
...
def analyze_cases(n_values, max_value, seed):
    ...
    for n in n_values:
        times = []
        for _ in range(10):  # Run multiple iterations for average case
...
# Parameters
last_three_digits_stambuk = 123  # Replace with your stambuk's last three digits
max_value = 250 - last_three_digits_stambuk
...
# Display worst case and average case times
